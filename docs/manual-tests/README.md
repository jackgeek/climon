...
| — | Installer-owned cross-platform updates — signed staging, installer-owned layout, and direct legacy Windows/macOS/Linux migration via a signed universal bootstrap | [installer-owned-updates.md](installer-owned-updates.md) |
