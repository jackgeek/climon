...
| — | Terminal selection mode (touch) — Select toggle enables native text selection + suppresses the soft keyboard | [terminal-select-mode.md](terminal-select-mode.md) |
