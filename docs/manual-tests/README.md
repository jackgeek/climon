...
[`../../harness/README.md`](../../harness/README.md) automates `DAR-01` through
`DAR-10` as its first DAR scenarios, and the GitHub Actions workflow
...
candidate. See [`results/README.md`](results/README.md) for how automated E2E
artifacts complement, but do not replace, release-candidate result rows.
