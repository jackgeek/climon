...
into the terminal, and whose text is retained when cancelled.
...
## TSA-3 — Cancel retains text and reveals the terminal
...
## TSA-4 — Insert button disabled when empty
...
- **Steps:**
  ...
  2. Inspect the Insert button.
- **Expected result:** Insert is disabled while the box is empty; Cancel remains
