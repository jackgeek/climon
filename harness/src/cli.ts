...
import {
  DAR_06_SUBCHECKS,
  runDar06 as runDar06Impl,
} from "./scenarios/dar-06.js";
import {
  DAR_07_SUBCHECKS,
  runDar07 as runDar07Impl,
} from "./scenarios/dar-07.js";
import {
  DAR_08_SUBCHECKS,
...
import {
  DAR_10_SUBCHECKS,
  runDar10 as runDar10Impl,
} from "./scenarios/dar-10.js";
...
const runDar06Adapter: ScenarioRunner = async ({
  platform,
  overallDeadline,
  build,
  runtime,
  ...
  if (typeof browser.createSurface !== "function") {
    throw new HarnessError(
      "browser",
      "Browser driver does not expose createSurface() for DAR-06"
    );
  }
...
const runDar07Adapter: ScenarioRunner = async ({
  platform,
  overallDeadline,
  build,
  runtime,
...
const runDar08Adapter: ScenarioRunner = async ({
  platform,
  overallDeadline,
  build,
  runtime,
  ...
  if (typeof browser.createSurface !== "function") {
    throw new HarnessError(
      "browser",
      "Browser driver does not expose createSurface() for DAR-08"
    );
  }
...
const runDar10Adapter: ScenarioRunner = async ({
  platform,
  overallDeadline,
  build,
  runtime,
