...
| `dashboard.touchWheelInverted` | boolean | `false` | server, browser | When true, reverses only the dashboard terminal's synthetic two-finger wheel gesture. Physical mouse and trackpad wheel direction is unchanged. |
